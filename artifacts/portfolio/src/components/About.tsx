          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                ...
                Artificial Intelligence applications, and UI/UX design. I enjoy building modern web
                applications, exploring AI technologies, and designing seamless user experiences.
                I am always eager to learn new technologies and create impactful digital products.
              </p>
              <div className="pt-6">
                <span
